...
export const activities: ActivityItem[] = [
  ...
  },
  {
    title: "Study Group",
    description:
      "Join our study group focused on web and mobile app development, where we delve into coding, deploying websites, and exploring frameworks.",
    iconColor: "amber",
  },
  {
    title: "Community",
    description:
      "Join our entrepreneurship club for networking, learning, and collaboration. Connect with fellow members, exchange ideas, and create together.",
    iconColor: "indigo",
  },
];
